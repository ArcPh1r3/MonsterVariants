...
namespace MonsterVariants.Modules.States
{
    public class LaunchingHeadbutt : BaseState
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.isAuthority)
            {
                this.attack.forceVector = (base.characterDirection ? (base.characterDirection.forward * LaunchingHeadbutt.pushForce) : Vector3.zero);
